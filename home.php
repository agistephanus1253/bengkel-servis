...
<html lang="en">
  ...
  <head>
    ...
    <title>PT.Bengkel Servis|Home</title>
      ...
      <div class="collapse navbar-collapse bg_tem" id="navbarResponsive">
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle mr-lg-4" href="#" id="alertsDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    ...
    <footer class="sticky-footer">
      <div class="container">
        <div class="text-center">
          <small>Copyright &copy;   PT. Bengkel Servis-2018</small>
        </div>
      </div>
    </footer>
