...
<head>
  <meta charset="UTF-8">
  <title>PT. Bengkel Servis|Login</title>
...
<body>
  <div class="wrapper">
	<div class="container">
		<h1>PT. Bengkel Servis <br>Login</h1>
		
		<form class="form" action="" method="post">
			<input type="Username" placeholder="Username" name="user" id="lgn_user" maxlength="30" autocomplete="off">
