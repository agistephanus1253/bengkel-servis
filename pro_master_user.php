...
switch ($pro) {
	case 'insert':
		...
		$usr_email=$_GET['usr_admin'];
		$usr_tlp=$_GET['usr_tlp'];
		$usr_konfir_pass=$_GET['usr_konfir_pass'];

		$insert=mysql_query("INSERT INTO tbl_user VALUES(NULL,'$usr_status','$usr_nama','$usr_jk','$usr_tempat_lahir','$usr_tgl_lahir','$usr_alamat','$usr_admin','$usr_tlp','$usr_konfir_pass')")or die(mysql_error());
		break;
